 ...
 */
public class RegisteredHomeChannelFragment extends Fragment {
    ...
    public RegisteredHomeChannelFragment() {
    ...
    public static RegisteredHomeChannelFragment newInstance(String param1, String param2) {
        RegisteredHomeChannelFragment fragment = new RegisteredHomeChannelFragment();

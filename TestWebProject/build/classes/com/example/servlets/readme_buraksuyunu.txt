...
{
	{
		SELECT (SAMPLE(?human) AS ?human) ?award ?awardWork (SAMPLE(?awardEdition) AS ?awardEdition) (SAMPLE(?time) AS ?time) WHERE {
...
human, awardEditionLabel, awardLabel, awardWork, time
David White,	88th Academy Awards,	Academy Award for Best Sound Editing,	Mad Max: Fury Road,	2016-02-28T00:00:00Z
